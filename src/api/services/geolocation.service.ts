import { GeolocationRepository, NearbySearchParams, RoutePoint, CSPOnRoute } from '@/api/repositories/geolocation.repository';
import { CSP, CSPWithDistance } from '@/shared/dto/csp.dto';
import { ValidationError } from '@/api/errors/custom-errors';
