# Inventario Detallado: Camiño Service Point

**Versión:** 1.0  
**Fecha:** 8 de octubre de 2025  
**Objetivo:** Listado exhaustivo de componentes, especificaciones técnicas y cantidades para presupuestar cada módulo del Service Point.

---

## 1. MÓDULO 1: Taller de Auto-Reparación (Pay-Per-Use)

### 1.1. Estructura y Mobiliario Base

| ID     | Componente                        | Especificaciones Técnicas                                                                      | Unidades por CSP | Proveedor Sugerido                            | Precio Unit. (€) | Total (€) | Notas                                                             |
| ------ | --------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------- | --------------------------------------------- | ---------------- | --------- | ----------------------------------------------------------------- |
| M1-E01 | Soporte de reparación profesional | Tipo caballete ajustable, carga máx. 30kg, rotación 360°, altura regulable 100-180cm           | 2                | Park Tool PCS-10.3, Feedback Sports Pro Elite | 239              | 478       | Precio Park Tool PCS-10.3 (mandobici.com) - Uso intensivo         |
| M1-E02 | Banco de trabajo                  | Superficie metálica antideslizante, dimensiones mín. 150x60cm, con tornillo de banco integrado | 1                | Fabricación local/carpintería metálica        | 380              | 380       | Banco metálico industrial 150x60cm + tornillo (Manutan, Grainger) |
| M1-E03 | Panel de herramientas             | Panel perforado o riel con ganchos, dimensiones 200x100cm, material resistente a intemperie    | 1                | Panel perforado metálico Mottez               | 125              | 125       | Panel 200x100cm + 50 ganchos (bricor.es, manomano.es)             |
| M1-E04 | Iluminación LED                   | Tiras LED 24V IP65, 6000K (luz blanca fría), mín. 3000 lúmenes total                           | 3m lineales      | Ledkia, Philips CorePro                       | 28               | 84        | Tira LED profesional IP65 3000lm, 28€/m (ledkia.com)              |
| M1-E05 | Compresor de aire portátil        | Min 8 bar, motor silencioso (<60dB), manómetro digital, con manguera 5m                        | 1                | Xiaomi Mi Portable Electric Air Compressor    | 42               | 42        | Portátil, recargable, <60dB (amazon.es, aliexpress)               |
| M1-E06 | Toma de corriente industrial      | Schuko IP44, mín. 16A, con protección diferencial                                              | 2                | Legrand Plexo IP44                            | 18               | 36        | Schuko estanca IP44 16A (leroymerlin.es, rexel.es)                |

### 1.2. Herramientas de Reparación (Set Completo)

#### 1.2.1. Herramientas de transmisión y cadena

| ID     | Herramienta                   | Especificaciones                                                                    | Unidades | Proveedor                           | Precio Unit. (€) | Total (€) | Notas                                           |
| ------ | ----------------------------- | ----------------------------------------------------------------------------------- | -------- | ----------------------------------- | ---------------- | --------- | ----------------------------------------------- |
| M1-H01 | Tronchacadenas profesional    | Compatible con cadenas 9-12 velocidades, con extractor de pin                       | 2        | Park Tool CT-3.3, Shimano TL-CN28   | 28               | 56        | Park Tool CT-3.3 (ciclomaniacos.com, bike24.es) |
| M1-H02 | Medidor de desgaste de cadena | Tipo calibrador dual (0.5% y 0.75%)                                                 | 2        | Park Tool CC-3.2                    | 12               | 24        | Calibrador doble (bike-components.de)           |
| M1-H03 | Látigo para cassette          | Doble cabeza, compatible con cadenas 8-12v                                          | 2        | Park Tool SR-12, BBB BTL-05         | 16               | 32        | Látigo cadena profesional (alltricks.es)        |
| M1-H04 | Llave para cassette           | Compatible con Shimano/SRAM HG y nuevas transmisiones XD/Micro Spline               | 2        | Park Tool FR-5.2, Shimano TL-LR15   | 22               | 44        | Llave cassette universal (mandobici.com)        |
| M1-H05 | Alicate eslabón rápido        | Para apertura/cierre de cadenas con Quick Link                                      | 2        | KMC Missing Link, Park Tool MLP-1.2 | 14               | 28        | Alicate master link (bike24.es)                 |
| M1-H06 | Herramienta para bielas       | Juego completo: extractor de bielas cuadradillas + llave para eje Hollowtech II/DUB | 1 set    | Park Tool CWP-7 + adaptadores       | 65               | 65        | Kit completo bielas (bike-components.de)        |

#### 1.2.2. Herramientas para ruedas y neumáticos

| ID     | Herramienta                           | Especificaciones                                                                          | Unidades | Proveedor                                  | Precio Unit. (€) | Total (€) | Notas                                           |
| ------ | ------------------------------------- | ----------------------------------------------------------------------------------------- | -------- | ------------------------------------------ | ---------------- | --------- | ----------------------------------------------- |
| M1-H07 | Desmontables profesionales            | Set de 3 unidades, material compuesto (no dañan llantas), diseño ergonómico               | 3 sets   | Schwalbe, Pedro's Tire Levers              | 5                | 15        | Set 3 desmontables (decathlon.es, alltricks.es) |
| M1-H08 | Llave para radios (tipo 3 en 1)       | Compatible con radios 3.2, 3.3, 3.5mm (Mavic, DT Swiss, Sapim)                            | 2        | Park Tool SW-7.2, Unior 1662               | 18               | 36        | Llave radios 3 medidas (bike-components.de)     |
...
| ID Producto | Nombre del Producto                | Especificación                                          | Cant. Inicial | Proveedor                               | Precio Unit. (€) | Total (€) | Rotación Estimada                       |
| ----------- | ---------------------------------- | ------------------------------------------------------- | ------------- | --------------------------------------- | ---------------- | --------- | --------------------------------------- |
...
| C-L02       | Lubricante cadena (condiciones húmedas) | Bote 100ml con aplicador    | 20            | Finish Line Wet, Muc-Off Wet         | 7.80             | 156       | Muy Alta (Galicia) - Lluvia frecuente |
...
**TOTAL MÓDULO 2 (Hardware + Stock Inicial):** **6,398.90€** (con refrigeración: 6,818.90€)

---

## 3. MÓDULO 3: Estación de Lavado (Opcional)

| ID     | Componente                           | Especificaciones Técnicas                             | Unidades | Proveedor                               | Precio Unit. (€) | Total (€) | Notas                                                         |
| ------ | ------------------------------------ | ----------------------------------------------------- | -------- | --------------------------------------- | ---------------- | --------- | ------------------------------------------------------------- |
| M3-L01 | Hidrolimpiadora de bajo consumo      | Presión 100-120 bar, caudal 6 L/min, motor silencioso | 1        | Kärcher K3, Bosch AQT 37-13             | 165              | 165       | Hidro limpiadora doméstica robusta (leroymerlin.es)           |
| M3-L02 | Manguera de alta presión             | 8 metros, conectores rápidos                          | 1        | Kärcher 8m extensión                    | 28               | 28        | Manguera compatible Kärcher (amazon.es)                       |
| M3-L03 | Lanza con cepillo                    | Boquilla ajustable + cepillo de cerdas suaves         | 1        | Kärcher WB60 Wash Brush                 | 32               | 32        | Cepillo rotativo para bici (manomano.es)                      |
| M3-L04 | Sistema de pago integrado            | Lector de QR/NFC, temporizador digital                | 1        | Nayax VPOS Touch (reutilizado) o Payter | 0                | 0         | Puede usar mismo lector de vending (ya contado)               |
| M3-L05 | Deposito de agua (si no hay red)     | 200L, con bomba de presión                            | 1        | Depósito IBC 200L + bomba               | 145              | 145       | Solo si NO hay conexión a red - Depósito+bomba (bricomart.es) |
| M3-L06 | Sistema de drenaje                   | Rejilla y canalización al desagüe                     | 1        | Fontanería local                        | 85               | 85        | Obra civil, rejilla + canalización (obra local)               |
| M3-L07 | Productos de limpieza biodegradables | Champú para bici concentrado, 5L                      | 2        | Muc-Off Bike Cleaner 5L, Finish Line    | 38               | 76        | Champú concentrado para dispensador (ciclomaniacos.com)       |

**TOTAL MÓDULO 3 (Estación de Lavado):** **531€** (sin depósito agua: 386€)

---

## 4. MÓDULO 4: Punto de Carga para E-Bikes (Opcional)

| ID     | Componente                 | Especificaciones Técnicas                            | Unidades | Proveedor                            | Precio Unit. (€) | Total (€) | Notas                                              |
| ------ | -------------------------- | ---------------------------------------------------- | -------- | ------------------------------------ | ---------------- | --------- | -------------------------------------------------- |
| M4-C01 | Locker de carga seguro     | 4 compartimentos con candado electrónico, 220V       | 1        | Locker metálico 4 puertas AliExpress | 1.850            | 1.850     | Locker carga 4 bicis eléctrico (aliexpress.com)    |
| M4-C02 | Cargadores universales     | Compatible Bosch, Shimano, Brose (multi-conector)    | 4        | Cargador universal 36V/42V           | 62               | 248       | 4 cargadores universales e-bike (amazon.es)        |
| M4-C03 | Panel de control y pago    | Pantalla táctil, tarifas por hora, lector NFC        | 1        | Nayax VPOS Touch (reutilizado)       | 0                | 0         | Se puede usar mismo lector de vending (ya contado) |
| M4-C04 | Sistema de ventilación     | Ventiladores internos para evitar sobrecalentamiento | 1        | Ventilador industrial 220V           | 45               | 45        | Ventilador industrial extractor (leroymerlin.es)   |
| M4-C05 | Protección eléctrica       | Magnetotérmico + diferencial + toma tierra           | 1        | Schneider cuadro protección          | 78               | 78        | Cuadro eléctrico protección (leroymerlin.es)       |
| M4-C06 | Señalética y manual de uso | Instrucciones multiidioma (ES/EN/FR/PT)              | 1        | Vinilo impresión local               | 35               | 35        | Cartel instructivo plastificado (imprenta local)   |

**TOTAL MÓDULO 4 (Punto de Carga E-Bikes):** **2.256€**

---

## 5. ESTRUCTURA FÍSICA (Solo para CSS - Camiño Service Station Propia)

### 5.1. Diseño y Licencias

| ID    | Componente/Servicio              | Descripción                                                                  | Unidades | Proveedor                | Precio Unit. (€) | Total (€) | Notas                                                        |
| ----- | -------------------------------- | ---------------------------------------------------------------------------- | -------- | ------------------------ | ---------------- | --------- | ------------------------------------------------------------ |
| E-D01 | Proyecto de arquitectura modular | Diseño de estructura prefabricada tipo "contenedor", dimensiones aprox. 6x3m | 1        | Arquitecto técnico local | 850              | 850       | Incluye planos constructivos y memoria (colegio arquitectos) |
| E-D02 | Licencia de obra menor           | Tramitación administrativa (ayuntamiento)                                    | 1        | Gestoría local           | 320              | 320       | Varía según municipio (promedio estimado)                    |
| E-D03 | Tasas municipales                | Canon/tasa de ocupación de suelo público (si aplica)                         | Anual    | Ayuntamiento             | 500              | 500       | Negociación individual por ubicación (estimado 500€/año)     |

**Subtotal Diseño y Licencias:** **1.670€**

### 5.2. Materiales de Construcción

| ID    | Material                        | Especificaciones                                         | Unidades | Proveedor                               | Precio Unit. (€) | Total (€) | Notas                                                   |
| ----- | ------------------------------- | -------------------------------------------------------- | -------- | --------------------------------------- | ---------------- | --------- | ------------------------------------------------------- |
| E-M01 | Contenedor marítimo 20' (usado) | Dimensiones 6x2.4x2.6m, estructura de acero corten       | 1        | Contenedores del Norte / Contenur       | 2.200            | 2.200     | Base para CSS, personalizable (contenedoresdelnorte.es) |
| E-M02 | Aislamiento térmico             | Panel sandwich 50mm (interior)                           | 20 m²    | Leroy Merlin panel sandwich             | 24               | 480       | Para condiciones climáticas extremas (leroymerlin.es)   |
| E-M03 | Revestimiento exterior          | Chapa lacada o vinilo de marca Camiño Service            | 20 m²    | Rotulación profesional                  | 28               | 560       | Imagen de marca consistente (rotulación local)          |
| E-M04 | Puerta de acceso                | Puerta metálica con cerradura electromagnética, 90x200cm | 1        | Carpintería metálica Dierre / Securitas | 420              | 420       | Integrada con sistema de acceso M1-S01 (ferreterías)    |
| E-M05 | Ventanas/ventilación            | Ventanas correderas de aluminio con reja, 80x60cm        | 2        | Carpintería aluminio K-LINE             | 165              | 330       | Ventilación cruzada (leroymerlin.es)                    |
| E-M06 | Suelo interior                  | Pavimento vinílico antideslizante                        | 15 m²    | Leroy Merlin Gerflor Traffic            | 22               | 330       | Resistente a manchas de aceite (leroymerlin.es)         |

**Subtotal Materiales Construcción:** **4.320€**

### 5.3. Cimentación y Acometidas

| ID    | Trabajo/Material                          | Descripción                                                | Unidades | Proveedor                                    | Precio Unit. (€) | Total (€) | Notas                                                  |
| ----- | ----------------------------------------- | ---------------------------------------------------------- | -------- | -------------------------------------------- | ---------------- | --------- | ------------------------------------------------------ |
| E-C01 | Explanación y nivelación del terreno      | Preparación de base, 20m²                                  | 1        | Empresa de obra civil local                  | 650              | 650       | Incluye compactado (obra local estimada)               |
| E-C02 | Cimentación (solera de hormigón)          | Solera armada 15cm espesor, 18m²                           | 1        | Empresa de obra civil local                  | 1.250            | 1.250     | Con anclajes para contenedor (obra local)              |
| E-C03 | Acometida eléctrica                       | Conexión a red, cuadro eléctrico, potencia contratada 10kW | 1        | Electricista autorizado + compañía eléctrica | 1.850            | 1.850     | Incluye legalización (electricista + Iberdrola/Endesa) |
| E-C04 | Acometida de agua (si aplica para lavado) | Conexión a red municipal o depósito                        | 1        | Fontanero + compañía aguas                   | 480              | 480       | Solo si se instala módulo de lavado (estimado)         |
| E-C05 | Sistema de desagüe                        | Arqueta y conexión a alcantarillado                        | 1        | Fontanero                                    | 320              | 320       | Cumplimiento normativa (obra fontanería local)         |

**Subtotal Cimentación y Acometidas:** **4.550€**

**TOTAL MÓDULO 5 (Estructura Física CSS):** **10.540€**

---

## 6. BRANDING Y SEÑALÉTICA

| ID   | Elemento                            | Descripción                                                                        | Unidades por CSP | Proveedor                                              | Precio Unit. (€) | Total (€) | Notas                                                       |
| ---- | ----------------------------------- | ---------------------------------------------------------------------------------- | ---------------- | ------------------------------------------------------ | ---------------- | --------- | ----------------------------------------------------------- |
| B-01 | Placa exterior de marca (iluminada) | Letrero tipo "caja de luz" LED, 200x80cm, doble cara, diseño corporativo           | 1                | Rotulación profesional LED (Rótulos Madrid, New Print) | 680              | 680       | Visible desde 50m, bajo consumo (rotulos-publicitarios.com) |
| B-02 | Vinilos de marca en módulos         | Vinilo adhesivo de alta adherencia, diseño de marca en puertas y laterales         | 1 set            | Rotulación local                                       | 185              | 185       | Incluye diseño gráfico (rotulación local)                   |
| B-03 | Panel informativo interior          | Panel rígido A2 con instrucciones de uso (multiidioma: ES, EN, FR, DE)             | 2                | Imprenta local Vistaprint                              | 22               | 44        | Uno en taller, uno en vending (vistaprint.es)               |
| B-04 | Señalización vertical en ruta       | Poste direccional tipo "flecha", 150x30cm, reflectante, ubicado 200m antes del CSP | 2                | Señalización vial Seton / Rsignal                      | 95               | 190       | Gestión de permisos con ayuntamiento (seton.es)             |
| B-05 | Pegatinas de marca (pequeñas)       | Stickers resistentes, 10x10cm, para regalar a usuarios                             | 500              | Imprenta online (Stickermule, Vistaprint)              | 0.28             | 140       | Marketing de bajo coste (stickermule.com/es)                |
